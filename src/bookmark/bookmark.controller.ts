...
export class BookmarkController {
    ...
    @Post()
    createBookmark(@Body() dto:CreateBookmarkDto, @GetUser('id') userId:number){
    ...
    @Patch('/:id')
    editBookmarkById(@Param('id', ParseIntPipe) id:number, @Body() dto:EditBookmarkDto, @GetUser('id') userId:number ){
